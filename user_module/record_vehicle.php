    ...
    <div class="overflow-auto">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand" href="record_vehicle.php">
                    ...
                    <form action="editcode.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="req_name" id="req_name" class="form-control" value=<?php echo  $_SESSION['staff_id'] ?> readonly>
                            </div>

                            <div class="form-group">
                                <label> Recipient Division/ Unit </label>
                                <input type="text" class="form-control" id="rec_div" name="rec_div" required="required" readonly>
                            </div>

                            <div class="form-group">
                                <label> Vehicle Type </label><br>

                                <input type="text" class="form-control" id="v_type" name="v_type" required="required" readonly>

                            </div>

                            <div class="form-group">
                                <label> Vehicle Model </label><br>
                                <input type="text" class="form-control" id="v_model" name="v_model" required="required" readonly>
                            </div>

                            <div class="form-group">
                                <label>Quantity</label>
                                <input class="form-control" required="required" id="quantity" name="quantity">
                            </div>
                            <div class="form-group">
                                <label>Justification </label>
                                <input class="form-control" required="required" id="justification" name="justification">
                            </div>

                            <div class="form-group">
                                <label>Attachment(1) <p class="text-muted">*Required: Official paper approved by Head of Division</p> </label>
                                <input type="file" id="att1" name="att1" class="form-control" multiple required="required">
                            </div>
                            <div class="form-group">
                                <label>Attachment(2) <p class="text-muted">*Optional: Quotation from Vendor </p> </label>
                                <input type="file" id="att2" name="att2" class="form-control" multiple>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="deletecode.php" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="deletedata" class="btn btn-primary"> Proceed to Delete </button>
                        </div>
                    </form>
